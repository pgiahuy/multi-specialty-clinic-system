...
const MedicalRecord = () => {
    ...
    const loadMedicalRecord = async () => {
        try {
            ...
            handleShowAlert("Lỗi", "Tải bệnh án thất bại!", "danger");
    ...
    const loadTestResults = async () => {
        try {
            ...
            handleShowAlert("Lỗi", "Tải kết quả xét nghiệm thất bại!", "danger");
        }
    };
                        ...
                        <Card className="border-0 shadow-sm rounded-3 overflow-hidden">
                            <Card.Header className="bg-primary text-white p-3 pt-2 pb-2 d-flex justify-content-between align-items-center border-0">
                                <div className="d-flex align-items-center gap-2">
                                    <h5 className="mb-0 fw-bold tracking-wide">CHI TIẾT HỒ SƠ BỆNH ÁN</h5>
                                </div>
